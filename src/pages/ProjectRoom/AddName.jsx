  ...
  return (
    <div className={`relative ${haveName ? "hidden" : ""} text-center w-full`}>
      <div className="relative w-1/2 mx-auto">
        <h1 className="relative z-10 mt-12 mb-40 text-6xl font-black text-center font-playfair-display">
          {roomId}
        </h1>
        <div className="absolute w-1/2 h-10 mx-auto bg-yellow-100 top-1/2 left-36"></div>
      </div>
      <div
        className={`mt-10 relative w-1/3 mx-auto text-xl font-medium font-open-san`}
      >
        <input
          value={newUser}
